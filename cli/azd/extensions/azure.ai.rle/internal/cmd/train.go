...
func newTrainCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			invokeArgs := buildLoomTrainArgs(state, state.Project, controlPlane, flags)
...
func buildLoomTrainArgs(state rleState, project string, controlPlane string, flags *rleTrainFlags) []string {
	args := []string{
